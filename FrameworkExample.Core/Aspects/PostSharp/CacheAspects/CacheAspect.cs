using FrameworkExample.Core.CrossCuttingConcerns.Caching;
...
// Use in manager methods : [CacheAspect(typeof(MemoryCacheManager))]

namespace FrameworkExample.Core.Aspects.Postsharp.CacheAspects
{
    [Serializable]
